...
public class ServletUsuari extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (tipus.equals("login")) {
            GestorBBDDUsuaris gestorUsuaris = new GestorBBDDUsuaris("C:/Users/Adria/Documents/GitHub/WebRobot/src/java/robot.sqlite");
            ...
            if (loginCorrecte) {
                GestorBBDDSessioRobot gestorSessio = new GestorBBDDSessioRobot("C:/Users/Adria/Documents/GitHub/WebRobot/src/java/robot.sqlite");
                ...
                if (robotDisponible) {
                    ...
                    } else if (control.equals("ratoli")) {
                        RequestDispatcher dispatcher = request.getRequestDispatcher("controlRatoli.jsp");
                        dispatcher.forward(request, response);
                        response.sendRedirect("controlRatoli.jsp");
                    } else if (control.equals("mobil")) {
                        RequestDispatcher dispatcher = request.getRequestDispatcher("controlMobil.jsp");
                        dispatcher.forward(request, response);
                        response.sendRedirect("controlMobil.jsp");
                    }
